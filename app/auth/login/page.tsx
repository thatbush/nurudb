      ...
      <div className="hidden w-1/2 flex-col justify-between p-8 text-white lg:flex relative">
        ...
        <section className='relative z-10 mt-16 bottom-1 left-0 right-0'>
          <div className='grid grid-cols-2'>
            <div>
              <p className='text-primary text-xs'>© {new Date().getFullYear()} Nuru. All rights reserved. | Photo by <a href='https://pexels.com/@martinkirigua' className='text-primary hover:underline'>Martin Kirigua</a></p>
            </div>
